...
<template>
  <div class="bg-gray-300 rounded-lg shadow-xl flex flex-col md:flex-row justify-between items-center gap-1 p-2">
    ...
    <div class="flex gap-2">
      <button @click="toggleModal()" class="bg-green-800 rounded-md cursor-pointer shadow-sm px-2 text-gray-200 font-semibold hover:bg-green-700 hover:text-gray-100 py-1">Add Customer</button>
